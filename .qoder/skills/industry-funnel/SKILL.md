...
This skill is generated from `skills/industry-funnel.md`. Qoder and Claude Code share one canonical workflow.
...
1. **报告位置**：`qoder_report/{行业名}-funnel-{YYYYMMDD}.md`（行业报告放 qoder_report/ 根目录）
2. **语言**：中文
3. **风格**：直接、犀利、不说废话
