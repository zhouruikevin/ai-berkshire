---
name: thesis-drift
description: AI Berkshire 投研技能：投资论文漂移检测：分清事实变化与措辞变化。来源 skills/thesis-drift.md。
---

## Qoder adapter note

This skill is generated from `skills/thesis-drift.md`. Qoder and Claude Code share one canonical workflow.
